...
class TrainingPipelineConfig:
    ...
    pipiline_name: str = PIPELINE_NAME
...
class DataIngestionConfig:
    ...
    feature_score_file_path: str = os.path.join(data_ingestion_dir, DATA_INGESTION_FEATURE_STORE_DIR, FILE_NAME)
    traning_file_path: str = os.path.join(data_ingestion_dir, DATA_INGESTION_DIR_NAME, TRAIN_FILE_NAME)
